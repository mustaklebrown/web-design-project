    ...
    return (
        <div className='max-w-7xl w-full min-h-screen mx-auto p-4 xl:p-0 flex flex-col items-center justify-center   '>
            <div className='md:flex items-start md:gap-10 space-y-10 md:space-y-0'>
                ...
                <div className='md:w-[46%] overflow-hidden w-full max-h-[600px]'>
                    <Image src={`${design?.image}`} width={600} height={600} alt='rest-image' className='w-full h-full rounded-md object-cover object-center' />
                </div>
